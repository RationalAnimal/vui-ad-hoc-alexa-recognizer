...
To that end I have set up a web site on GitHub pages and included the first six tutorials, with more on the way.
...
And the last one show the use of what is probably the singularly most useful built in slot type - NUMBER.
